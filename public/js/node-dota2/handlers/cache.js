...
function handleDestroyType(obj_type, object_data) {
    switch(obj_type) {
        ...
        case cacheTypeIDs.CSODOTALobbyInvite:
            this.Logger.debug("LobbyMiddleware invite cleared");
...
function handleSubscribedType(obj_type, object_data, isDelete) {
    switch (obj_type) {
        ...
        case cacheTypeIDs.CSODOTALobby:
            ...
            this.Lobby = lobby;
            break;
        // LobbyMiddleware invite snapshot.
        case cacheTypeIDs.CSODOTALobbyInvite:
 ...
 */
 /**
 * Emitted when the LobbyMiddleware Invite is cleared, for example when

    ...
    fs=require("fs");
        ...
        Dota2.on("chatLeave", function(channel, leaver_steam_id, otherLeft_object) {
                 ...
                 setTimeout(function(){
                  ...
                  console.log(leaver_steam_id+" leave lobby", lobbyChannel);
                 }, 1000);
             });
...
/*                if(dota2._getMessageName(kMsg) == 'k_EMsgGCToClientMatchSignedOut'){
             Dota2.on("practiceLobbyUpdate", function(lobby_data) {
                lobby = lobby_data;
                util.log(lobby);
                fs=require("fs");
                ...
                fs.writeFileSync("test.end", result);  
        });
        }*/
    });
    }
